# Web Development Project 1 - *Sport One*
...
The current site relies on an external api for league information. I would like to built my own api to circumvent the api restrictions. I will be using Selenium for this and I will be scrapping the nba and la liga/premier league websites.
